...
export default function Gallery() {
  return (
    <section id="gallery" className="py-24 bg-slate-50 scroll-mt-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16 space-y-4">
          ...
          <h3 className="text-3xl sm:text-4xl font-extrabold text-slate-900 tracking-tight">
            Step Inside Gurugram’s Safest Dental Oasis
          </h3>
          <p className="text-slate-600 text-base">
            Take a visual tour of Cliniva Dental Clinic in DLF Phase 2. Designed for supreme hygienic comfort, featuring world-class sterilization and high-tech operatories.
          </p>
        </div>
