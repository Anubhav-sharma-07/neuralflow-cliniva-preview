...
export default function FloatingButtons({ onOpenBookingModal }: FloatingButtonsProps) {
  ...
  return (
    <div id="floating-actions" className="fixed bottom-6 right-6 z-40 flex flex-col gap-3.5 items-end">
      ...
      {/* Tap-to-Call Sticky Button for quick phone dialing (mobile only) */}
      <a
        id="floating-call"
        href="tel:+919810371228"
        className="md:hidden bg-blue-600 hover:bg-blue-700 text-white p-4 rounded-full shadow-2xl transition-all hover:scale-110 active:scale-95 flex items-center justify-center border border-blue-500/50 group"
